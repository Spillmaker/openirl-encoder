## NB: Not a general-use ubuntu-image.
The images generated by this repo is custom tailored for the OpenIRL-encoder.
If you are looking for a general use linux/ubuntu image for use with Rockchip-devices, use the upstream repository at https://github.com/Joshua-Riek/ubuntu-rockchip
